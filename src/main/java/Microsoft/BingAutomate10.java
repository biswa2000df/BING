...
public class BingAutomate10 extends test2 {
...
//		driver.findElement(By.xpath("//*[text()='Sign in']")).click();
			...
			for (int i = 0; i < al.size(); i = i + 2) {
				...
				try {
					...
					coin30 = Totalpoint.substring(11, 16);
				} catch (Exception e) {
					coin30 = Totalpoint.substring(10, 15);
...
//		System.out.println(coin30);
				...
				String coin3030 = "30/30";

				if (coin3030.equalsIgnoreCase(coin30)) {
